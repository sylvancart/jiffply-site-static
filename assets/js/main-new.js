...
(function() {
  ...
  if (waitlistForm) {
    ...
    if (savedEmail) {
      ...
      if (submitBtn) {
        submitBtn.innerHTML = `
          <span class="btn-text">Active Trial</span>
          <svg class="check-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" style="display:none;"><polyline points="20 6 9 17 4 12"></polyline></svg>
        `;
    ...
    waitlistForm.addEventListener("submit", (e) => {
      ...
      if (submitBtn) {
        submitBtn.innerHTML = `
          <span class="btn-text">Registering...</span>
          <svg class="arrow-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="display:none;"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
        `;
        submitBtn.disabled = true;
      }
      ...
      setTimeout(() => {
        if (submitBtn) {
          submitBtn.innerHTML = `
            <span class="btn-text">Trial Activated!</span>
            <svg class="check-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" style="display:none;"><polyline points="20 6 9 17 4 12"></polyline></svg>
          `;
          submitBtn.style.background = "#00ffcc";
          submitBtn.style.color = "#030306";
